      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
            ...
            <span style={{ fontFamily: FONT_B, fontSize: 13.5, fontWeight: 700, color: C.sumi }}>
              {t.from} <span style={{ color: C.shu }}>→</span> {t.to}
            </span>
          </div>
          <div
            style={{
        ...
        <div style={{ textAlign: 'right', flexShrink: 0 }}>
          <div style={{ fontFamily: FONT_D, fontSize: 14, fontWeight: 700, color: C.ai }}>
            {t.time}
          </div>
