...
export const FONT_D = "'Shippori Mincho', 'Times New Roman', serif";
export const FONT_B = "'Zen Kaku Gothic New', system-ui, sans-serif";
export const FONT_R = "'Zen Maru Gothic', system-ui, sans-serif";
export const FONT_KR = "'Nanum Myeongjo', 'Shippori Mincho', serif";
export const FONT_GTA = "'Pricedown', 'Zen Kaku Gothic New', sans-serif";

export const seigaiha =
